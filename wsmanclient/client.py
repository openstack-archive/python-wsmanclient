...
class Client(object):
    ...
    def enumerate(self, resource_uri, optimization=True, max_elems=100,
        ...
        :raises: RequestFailure on request failures
        :raises: InvalidResponse when receiving invalid response
        :raises: InvalidFilterDialect when filter_dialect parameter is invalid
        """
    ...
    def __init__(self, endpoint, resource_uri, optimization=True,
        ...
        if filter_query is not None:
            try:
                ...
                raise exceptions.InvalidFilterDialect(
